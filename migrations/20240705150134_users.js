 ...
 * createTable() => "test_cases", deps: [modules, user_in_project, user_in_project]
 ...
 * createTable() => "issues", deps: [issue_priority, issue_status, issue_type, testcase_testrun, testcase_testrun, users, projects]
 ...
 * addIndex(projects_name_key) => "projects"
 ...
 * addIndex(test_run_status_pk) => "test_run_test_case_status"
 * addIndex(test_runs_pkey) => "test_runs"
 * addIndex(testcase_testrun_pkey) => "testcase_testrun"
 * addIndex(user_in_project_user_id_project_id_role_id_key) => "user_in_project"
 * addIndex(user_in_project_pk) => "user_in_project"
...
const info = {
  revision: 1,
  name: "noname",
  created: "2024-07-05T14:23:28.268Z",
  comment: "",
};
    ...
    params: [
      "test_cases",
      {
        ...
        created_by: {
          type: Sequelize.INTEGER,
          field: "created_by",
          // references: { model: "user_in_project", key: "user_id" },
          allowNull: true,
        },
        project_id: {
          type: Sequelize.INTEGER,
    ...
    params: [
      "issues",
      {
        ...
        test_case_id: {
          type: Sequelize.INTEGER,
          field: "test_case_id",
          // references: { model: "testcase_testrun", key: "testrun_id" },
          allowNull: true,
        },
        test_run_id: {
          type: Sequelize.INTEGER,
