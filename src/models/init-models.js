...
function initModels(sequelize) {
  ...
  user_in_project.hasMany(test_cases, { as: "test_cases", foreignKey: "project_id"});
  test_cases.belongsTo(user_in_project, { as: "created_by_user_in_project", foreignKey: "created_by"});
  user_in_project.hasMany(test_cases, { as: "created_by_test_cases", foreignKey: "created_by"});
